...
class PaperMarkService{
  ...
  static Future<AddMarkResponseModel?> updateMarks({
    ...
    try {
      final response = await APIProvider.instance.put('/mark/update/${markID}',{
        "paperId": paperID,
        "studentId": studentID,
        "essayMarks": essay,
        "mcqMarks": mcq,
  ...
  static Future<AddPaperResponseModel?> addPaper({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        //get response data as AllMarkDataModel
        AddPaperResponseModel addPaperResponseModel = AddPaperResponseModel.fromJson(response.data);
  ...
  static Future<ResponseModel?> deletePaper({
    required String paperID
  }) async {
    try {
      final response = await APIProvider.instance.delete('/paper/delete/$paperID',null);
      if (response.statusCode == 200) {
        //get response data as AllMarkDataModel
        ResponseModel deletePaperResponseModel = ResponseModel.fromJson(response.data);
